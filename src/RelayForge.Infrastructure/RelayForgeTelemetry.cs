...
public static class RelayForgeTelemetry
{
    ...
    public static readonly Counter<long> FinalizationRejected = Meter.CreateCounter<long>("relayforge.delivery.finalize_rejected");
    ...
    public static Activity? StartReplay(Guid deliveryId) { _ = deliveryId; return ActivitySource.StartActivity("delivery.replay"); }
